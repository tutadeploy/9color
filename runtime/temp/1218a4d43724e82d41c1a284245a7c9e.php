<?php /*a:1:{s:58:"D:\project\sd\application\index\view\ctrl\junior-pink.html";i:1667516890;}*/ ?>
<!DOCTYPE html><!-- saved from url=(0041)http://qiang6-www.baomiche.com/#/TeamList --><html data-dpr="1" style="font-size: 37.5px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="viewport" content="width=device-width,user-scalable=no,initial-scale=1,maximum-scale=1,minimum-scale=1"><title><?php echo lang('团队报表'); ?></title><link href="/static_new6/css/app.pink.css" rel="stylesheet"><script charset="utf-8" src="/static_new/js/jquery.min.js"></script><script charset="utf-8" src="/static_new/js/common.js"></script><script charset="utf-8" src="/static_new6/js/rolldate.js"></script><link rel="stylesheet" href="/static_new6/css/rolldate.css"><style type="text/css" title="fading circle style">
        ...
        .notdata{
            ...
            padding: 30px;
                 ...
                 style="z-index: 2003; display: none;"><div class="picker mint-datetime-picker"><div class="picker-toolbar"><span class="mint-datetime-action mint-datetime-cancel"><?php echo lang('取消'); ?></span><span
                            class="mint-datetime-action mint-datetime-confirm"><?php echo lang('确定'); ?></span></div><div class="picker-items"></div></div></div><button data-v-b7e8b406=""><?php echo lang('搜索'); ?></button></div></form><div data-v-b7e8b406="" class="report"><img src="../../web/img/shuqian.png" alt="" class="shuqian"><div data-v-b7e8b406="" class="lf"><h6  data-v-b7e8b406=""><?php echo lang('￥'); ?><?php echo htmlentities($teamyue); ?></h6><p data-v-b7e8b406=""><?php echo lang('团队余额'); ?>(<?php echo lang('美元'); ?>)</p></div><div data-v-b7e8b406="" class="rg red"><h6 data-v-b7e8b406=""><?php echo lang('￥'); ?><?php echo htmlentities($teamls); ?></h6><p data-v-b7e8b406=""><?php echo lang('团队流水'); ?>(<?php echo lang('美元'); ?>)</p></div><div data-v-b7e8b406="" class="lf"><h6 data-v-b7e8b406=""><?php echo lang('￥'); ?><?php echo htmlentities($teamcz); ?></h6><p data-v-b7e8b406=""><?php echo lang('团队总充值'); ?>(<?php echo lang('美元'); ?>)</p></div><div data-v-b7e8b406="" class="rg red"><h6 data-v-b7e8b406=""><?php echo lang('￥'); ?><?php echo htmlentities($teamtx); ?></h6><p data-v-b7e8b406=""><?php echo lang('团队总提现'); ?>(<?php echo lang('美元'); ?>)</p></div><div data-v-b7e8b406="" class="lf"><h6 data-v-b7e8b406=""><?php echo lang('￥'); ?><?php echo htmlentities($teamyj); ?></h6><p data-v-b7e8b406=""><?php echo lang('团队订单佣金'); ?>(<?php echo lang('美元'); ?>)</p></div><div data-v-b7e8b406="" class="d"><h6 data-v-b7e8b406=""> 0</h6><p data-v-b7e8b406=""><?php echo lang('首充人数'); ?></p></div><div data-v-b7e8b406="" class="d"><h6 data-v-b7e8b406=""><?php echo htmlentities($zhitui); ?></h6><p data-v-b7e8b406=""><?php echo lang('直推人数'); ?></p></div><div data-v-b7e8b406="" class="d"><h6 data-v-b7e8b406=""><?php echo htmlentities($tuandui); ?></h6><p data-v-b7e8b406=""><?php echo lang('团队人数'); ?></p></div><div data-v-b7e8b406="" class="d"><h6 data-v-b7e8b406=""><?php echo htmlentities($xinzeng); ?></h6><p data-v-b7e8b406=""><?php echo lang('新增人数'); ?></p></div><div data-v-b7e8b406="" class="d"><h6 data-v-b7e8b406=""><?php echo htmlentities($huoyue); ?></h6><p data-v-b7e8b406=""><?php echo lang('活跃人数'); ?></p></div></div><div data-v-b7e8b406="" class="mint-loadmore"><img src="../../web/img/shuqian.png" alt="" class="shuqian" style="top:0;"><div class="mint-loadmore-content"><div class="mint-loadmore-top"><!----><span class="mint-loadmore-text"><?php echo lang('下拉刷新'); ?></span></div><div data-v-b7e8b406="" class="nav ctrl-junior-nav"><button data-v-b7e8b406="" onclick="window.location.href='/index/ctrl/junior?level=1'" class="mint-button mint-button--default mint-button--normal btn <?php echo $level===1?'on':'' ?>"><!----><label class="mint-button-text"><?php echo lang('一级'); ?></label></button><button data-v-b7e8b406="" onclick="window.location.href='/index/ctrl/junior?level=2'" class="mint-button mint-button--default mint-button--normal btn <?php echo $level==2?'on':'' ?>"><!----><label class="mint-button-text"><?php echo lang('二级'); ?></label></button><button data-v-b7e8b406="" onclick="window.location.href='/index/ctrl/junior?level=3'" class="mint-button mint-button--default mint-button--normal btn <?php echo $level==3?'on':'' ?>"><!----><label class="mint-button-text"><?php echo lang('三级'); ?></label></button></div><div data-v-b7e8b406="" class="page-tab-container hot"><div data-v-b7e8b406="" class="mint-tab-container page-tabbar-tab-container"><div class="mint-tab-container-wrap"><div data-v-b7e8b406="" class="mint-tab-container-item"><ul data-v-b7e8b406=""><?php if($list): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;                                    //充值
