(function(d, s, id, w, n) {
    ...
    // 修改为本地路径
    var localUrl = window.location.origin, path = '/public/js/salesmartly-install.js';
    var cs = d.currentScript, csUrl = localUrl;
    ...
    js.onerror = function() {
        ...
        // 如果本地加载失败，回退到原始URL
        var deUrl = atob('aHR0cHM6Ly9wbHVnaW4tY29kZS5zYWxlc21hcnRseS5jb20=');
        newJs.src = deUrl + '/chat/widget/code/install.js';
